...
First video
            ...
            <WebView
                    ...
                    source={{uri: 'https://www.youtube.com/embed/uGRZ2CzkFUo' }}
           />
        <Text style={{color:'#e93766', fontSize: 18}}>
Javascript Videos </Text>
<Text style={{color:'#8b0000', fontSize: 14}}>
Second video
            ...
            <WebView
                  ...
                  javaScriptEnabled={true}
                  domStorageEnabled={true}
                  source={{uri: 'https://www.youtube.com/watch?v=mPd2aJXCZ2g' }}
         />
           <Text style={{color:'#e93766', fontSize: 18}}>
Javascript Videos </Text>
<Text style={{color:'#8b0000', fontSize: 14}}>
Third video
           ...
           <WebView
                  ...
                  javaScriptEnabled={true}
                  domStorageEnabled={true}
                  source={{uri: 'https://www.youtube.com/embed/wK2cBMcDTss' }}
         />
           </View>
        </ScrollView>
